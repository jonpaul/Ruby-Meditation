...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  # Notice nil(lcase) is the object, whereas "nil" is still a string, Nil(capitalize) is a constant.
  # ------------------------------------------------------------------
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Why does or zero convert itself into nil as a string? Is it easier to mutate a string?
  end
  ...
  #Regex symbols apply to the character to the left
  ...
  def test_character_classes_give_options_for_a_character
    ...
    # Notice this method array_variable.select creates a new array from the regex parse
  end
  ...
  def test_shortcut_character_classes_are_negated_with_capitals
    ...
    # D anything != digit S anything != whitespace W is anything != digit or letter -- they return "not lcase_shortcut"
  end
